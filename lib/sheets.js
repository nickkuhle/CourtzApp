...
// of the booking, or the Apps Script writes nothing at all.
export async function bookGroup({ location, date, courtId, slots, names }) {
  const payload = { action: "bookGroup", location, date, courtId: String(courtId), slots, names }
  if (WEBAPP_URL) {
